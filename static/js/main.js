(() => {
  ...
  var init_popper_lite = __esm({
    "node_modules/@popperjs/core/lib/popper-lite.js"() {
      ...
      createPopper2 = /* @__PURE__ */ popperGenerator({
        defaultModifiers
      });
    }
  });
  ...
  var init_popper = __esm({
    "node_modules/@popperjs/core/lib/popper.js"() {
      ...
      createPopper3 = /* @__PURE__ */ popperGenerator({
  ...
  var init_bootstrap_esm = __esm({
    "node_modules/bootstrap/dist/js/bootstrap.esm.js"() {
      ...
      Alert = class _Alert extends BaseComponent {
        // Getters
        static get NAME() {
          return NAME$f;
        }
      ...
      Swipe = class _Swipe extends Config {
        constructor(element, config) {
          super();
          this._element = element;
      ...
      Carousel = class _Carousel extends BaseComponent {
        constructor(element, config) {
      ...
      Collapse = class _Collapse extends BaseComponent {
        constructor(element, config) {
          super(element, config);
      ...
      Modal = class _Modal extends BaseComponent {
        constructor(element, config) {
          super(element, config);
      ...
      Offcanvas = class _Offcanvas extends BaseComponent {
        constructor(element, config) {
          super(element, config);
          this._isShown = false;
          this._backdrop = this._initializeBackDrop();
      ...
      uriAttributes = /* @__PURE__ */ new Set(["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"]);
      ...
      Popover = class _Popover extends Tooltip {
        // Getters
        static get Default() {
          return Default$2;
        }
      ...
      ScrollSpy = class _ScrollSpy extends BaseComponent {
        constructor(element, config) {
          super(element, config);
      ...
      Tab = class _Tab extends BaseComponent {
        constructor(element) {
          super(element);
